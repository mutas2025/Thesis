...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validate credentials against program_heads table
    $query = "SELECT * FROM program_heads WHERE username = ?";
...
<head>
    ...
    <title>Program Head Login - School Management System</title>
