...
<head>
    <meta charset="utf-8">
    <title>Customer Payment OR Report</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div>Customer Payment OR Report</div>
        </div>
        ...
        <div class="report-title">
            <?= $reportType == 'daily' ? 'Daily' : 'Weekly' ?> Customer Payment OR Report
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- Fixed syntax error: removed extra closing curly brace } -->
